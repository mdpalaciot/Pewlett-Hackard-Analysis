...
SELECT emp_no, first_name, last_name, birth_date
INTO table_proposed_1
FROM employees
WHERE (birth_date BETWEEN '1964-01-01' AND '1964-12-31')
DROP TABLE table_proposed_1 CASCADE;
SELECT * FROM table_proposed_1;
SELECT * FROM employees;

SELECT table_proposed_1.emp_no,
     table_proposed_1.first_name,
	 table_proposed_1.last_name,
	 table_proposed_1.birth_date,
     table_4.from_date,
     table_4.to_date
INTO table_proposed_2
FROM table_proposed_1
INNER JOIN table_4
ON table_proposed_1.emp_no = table_4.emp_no
ORDER BY table_proposed_1.emp_no ;

DROP TABLE table_proposed_2 CASCADE;

SELECT table_proposed_2.emp_no,
     table_proposed_2.first_name,
	 table_proposed_2.last_name,
	 table_proposed_2.birth_date,
     table_proposed_2.from_date,
     table_proposed_2.to_date,
	 unique_titles_2.title
INTO mentorship_eligibilty_extended
FROM table_proposed_2
INNER JOIN unique_titles_2
ON table_proposed_2.emp_no = unique_titles_2.emp_no
WHERE (to_date BETWEEN '9999-01-01' AND '9999-01-01')
ORDER BY table_proposed_2.emp_no ;

DROP TABLE mentorship_eligibilty_extended CASCADE;

SELECT * FROM mentorship_eligibilty_extended;

--Proposed 2

SELECT  COUNT(mentorship_eligibilty_extended.title), 
mentorship_eligibilty_extended.title
INTO retiring_titles_proposed_2
FROM mentorship_eligibilty_extended
GROUP BY mentorship_eligibilty_extended.title
ORDER BY COUNT(mentorship_eligibilty_extended.title) DESC;

SELECT * FROM retiring_titles_proposed_2;

DROP TABLE retiring_titles_proposed_2 CASCADE;
